...
//                var toneX, toneA, toneXa, toneW, toneF, toneP, tonePer;
                ...
                $varControls.html('Keep-BG:<input onChange="toneGen()" id="toneBG" type="checkbox" checked = "true" >  <select onkeyup = "toneWave(this.value)" onChange = "toneWave(this.value)" value = "' + toneW + '" > <option value = "sine" > Sine wave </option> <option value = "square" > Square wave </option> <option value = "triangle" > Triangle wave </option> <option value = "saw" > Sawtooth wave </option> <option value = "random" > Random Block Wave </option>' +
                '</select><br/> Direction : <select onkeyup = "toneAxis(this.value)" onChange = "toneAxis(this.value)" value = "' + toneX + '" > <option value = "X" > Horizontal </option> <option value = "Y" > Vertical </option> </select><br/>' +
